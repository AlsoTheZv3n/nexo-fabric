...
import ch.nexoai.fabric.core.service.action.AuditService;
...
public class OntologyQueryResolver {
    ...
    private Map<String, Object> objectTypeSchemaToMap(ch.nexoai.fabric.adapters.out.persistence.entity.ObjectTypeEntity entity) {
